...
import type { CalendarProps as AriaCalendarProps, CalendarCellProps, CalendarGridProps } from 'react-aria-components';
import { Heading, Text } from '../components-ui/Content';
...
export function CalendarCell(props: CalendarCellProps) {
  return (
    <AriaCalendarCell {...props} className={`${styles['react-aria-CalendarCell']} button-base`} data-variant="quiet" />
  );
}
